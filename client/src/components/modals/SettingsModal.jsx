...
import { BingebaseSettingsSection } from '../config/BingebaseSettingsSection';
...
export function SettingsModal({
  ...
  const { preferences, setPreferences: onPreferencesChange, userId, handleAddCatalog } = useCatalog();
      ...
      >
        ...
        <div className="settings-modal-body">
          ...
          <CollapsibleSection
            title="Bingebase"
            icon={Globe}
            isExpanded={expandedSection === 'bingebase'}
            onToggle={() => toggleSection('bingebase')}
          >
            <BingebaseSettingsSection
              userId={userId}
