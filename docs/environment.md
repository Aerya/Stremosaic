...
| Variable        | Description                                                                                                                                   | Default    |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| `ADDON_VARIANT` | Changes addon ID and display name. Set to `nightly` to produce ID `community.tmdb.discover.plus.nightly` and name "Stremosaic (Nightly)". | _(stable)_ |
...
POSTGRES_URI=postgres://user:pass@db:5432/stremosaic
CACHE_DRIVER=redis
