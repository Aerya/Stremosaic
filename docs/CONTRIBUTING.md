# Contributing to Stremosaic

Thank you for your interest in contributing to Stremosaic! This document provides guidelines and information for contributors.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/stremosaic.git
   cd stremosaic
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/semicolumn/stremosaic.git
   ```
