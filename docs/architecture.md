...
Stremosaic is a Stremio addon that lets users create custom content catalogs powered by TMDB's Discover API. It consists of an Express server implementing the Stremio addon protocol and a React SPA ("Catalog Builder") for configuration.
